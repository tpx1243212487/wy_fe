  ...
  <el-main>
    ...
    <el-table :height="tableHeight" :data="tableList" border stripe>
      ...
      <el-table-column align="center" width="480" label="操作">
        <template slot-scope="scope">
          <el-button v-if="hasPerm('sys:liveUser:add')" type="success" size="small" @click="editBtn(scope.row)"
            >编辑</el-button
          >
          <el-button v-if="hasPerm('sys:liveUser:assignHome')" type="primary" size="small" @click="assignHose(scope.row)"
            >分配房屋</el-button
          >
          <el-button v-if="hasPerm('sys:liveUser:assignCar')" type="success" size="small" @click="assignPark(scope.row)"
            >分配车位</el-button
          >
          <el-button v-if="hasPerm('sys:liveUser:returnHome')" type="danger" size="small" @click="leaveHose(scope.row)"
            >退房</el-button
          >
          <el-button v-if="hasPerm('sys:liveUser:returnCar')" type="warning" size="small" @click="leavePark(scope.row)"
            >退车位</el-button
          >
